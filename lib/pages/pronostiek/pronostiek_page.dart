...
class PronostiekPage extends StatefulWidget {
  final Widget drawer;
  ...
  @override
  State<PronostiekPage> createState() => _PronostiekPageState();
}

class _PronostiekPageState extends State<PronostiekPage> {
  int _tabIndex = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(
        index: _tabIndex,
        children: [
          Visibility(maintainState: true, visible: _tabIndex==0,child: const PronostiekMatches()),
          Visibility(maintainState: true, visible: _tabIndex==1,child: const PronostiekProgression()),
          Visibility(maintainState: true, visible: _tabIndex==2,child: const PronostiekRandom()),
        ],
      ),
    );
  }
