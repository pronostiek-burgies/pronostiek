...
Map<String,Team> getTeams() {
  ...
  "B3": Team("USA", "USA", "us", "B3"),
  "B4": Team("Wales", "WAL", "gb-wls", "B4"),

  "C1": Team("Argentina", "ARG", "ar", "C1"),
  "C2": Team("Saudi Arabia", "KSA", "sa", "C2"),
  "C3": Team("Mexico", "MEX", "mx", "C3"),
  "C4": Team("Poland", "POL", "pl", "C4"),
  ...
  "F1": Team("Belgium", "BEL", "be", "F1"),
  "F2": Team("Canada", "CAN", "ca", "F2"),
  "F3": Team("Morocco", "MAR", "ma", "F3"),
  "F4": Team("Croatia", "CRO", "hr", "F4"),
  ...
  "H2": Team("Ghana", "GHA", "gh", "H2"),
  "H3": Team("Uruguay", "URU", "uy", "H3"),
  "H4": Team("Korea Republic", "KOR", "kr", "H4"),
  };
}