...
Map<String,Match> getMatches(Map<String,Team> teams, MatchController controller) {
  ...
  return {
    ...
    "R16A": Match.knockout("R16A", DateTime.utc(2022, 12, 3, 16-1, 00), "Winner A", "Runner-up B", () => getWinnerOfGroup("A"), () => getRunnerUpOfGroup("B"), MatchType.roundOf16, sporzaApi: 3311895),
    "R16C": Match.knockout("R16C", DateTime.utc(2022, 12, 3, 20-1, 00), "Winner C", "Runner-up D", () => getWinnerOfGroup("C"), () => getRunnerUpOfGroup("D"), MatchType.roundOf16, sporzaApi: 3311897),
    "R16E": Match.knockout("R16E", DateTime.utc(2022, 12, 5, 16-1, 00), "Winner E", "Runner-up F", () => getWinnerOfGroup("E"), () => getRunnerUpOfGroup("F"), MatchType.roundOf16, sporzaApi: 3311899),
    "R16G": Match.knockout("R16G", DateTime.utc(2022, 12, 5, 20-1, 00), "Winner G", "Runner-up H", () => getWinnerOfGroup("G"), () => getRunnerUpOfGroup("H"), MatchType.roundOf16, sporzaApi: 3311901),
    "R16B": Match.knockout("R16B", DateTime.utc(2022, 12, 4, 20-1, 00), "Winner B", "Runner-up A", () => getWinnerOfGroup("B"), () => getRunnerUpOfGroup("A"), MatchType.roundOf16, sporzaApi: 3311896),
    "R16D": Match.knockout("R16D", DateTime.utc(2022, 12, 4, 16-1, 00), "Winner D", "Runner-up C", () => getWinnerOfGroup("D"), () => getRunnerUpOfGroup("C"), MatchType.roundOf16, sporzaApi: 3311898),
    "R16F": Match.knockout("R16F", DateTime.utc(2022, 12, 6, 16-1, 00), "Winner F", "Runner-up E", () => getWinnerOfGroup("F"), () => getRunnerUpOfGroup("E"), MatchType.roundOf16, sporzaApi: 3311900),
    "R16H": Match.knockout("R16H", DateTime.utc(2022, 12, 6, 20-1, 00), "Winner H", "Runner-up G", () => getWinnerOfGroup("H"), () => getRunnerUpOfGroup("G"), MatchType.roundOf16, sporzaApi: 3311902),

    "QF1": Match.knockout("QF1", DateTime.utc(2022, 12,  9, 20-1, 00), "Winner R16A", "Winner R16C", () => getWinnerOfMatch("R16A"), () => getWinnerOfMatch("R16C"), MatchType.quarterFinals, sporzaApi: 3311887),
    "QF2": Match.knockout("QF2", DateTime.utc(2022, 12,  9, 16-1, 00), "Winner R16E", "Winner R16G", () => getWinnerOfMatch("R16E"), () => getWinnerOfMatch("R16G"), MatchType.quarterFinals, sporzaApi: 3311889),
    "QF3": Match.knockout("QF3", DateTime.utc(2022, 12, 10, 20-1, 00), "Winner R16B", "Winner R16D", () => getWinnerOfMatch("R16B"), () => getWinnerOfMatch("R16D"), MatchType.quarterFinals, sporzaApi: 3311888),
    "QF4": Match.knockout("QF4", DateTime.utc(2022, 12, 10, 16-1, 00), "Winner R16F", "Winner R16G", () => getWinnerOfMatch("R16F"), () => getWinnerOfMatch("R16G"), MatchType.quarterFinals, sporzaApi: 3311890),
